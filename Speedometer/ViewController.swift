...
private let maxDisplayableSpeed: CLLocationSpeed = 40  // m/s so 144 km/h
...
class ViewController: UIViewController {
    ...
    @IBAction func didTapMaxSpeed(_ sender: Any) {
        ...
        alertController.addTextField { [weak self] (textfield) in
            ...
            let okAction = UIAlertAction(title: "Okay", style: .default, handler: { [weak self] (_) in
